 ...
 * @author weeec
 */
public class Tile_8 extends Tile{
    public Tile_8(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile8, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile8.getWidth(),Assets.tile8.getHeight());
    }
