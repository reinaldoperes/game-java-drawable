 ...
 * @author weeec
 */
public class Tile_12 extends Tile{
    public Tile_12(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile12, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile12.getWidth(),Assets.tile12.getHeight());
    }
