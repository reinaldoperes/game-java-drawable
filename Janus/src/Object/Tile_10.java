 ...
 * @author weeec
 */
public class Tile_10 extends Tile{
    public Tile_10(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile10, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile10.getWidth(),Assets.tile10.getHeight());
    }
