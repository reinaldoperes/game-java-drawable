 ...
 * @author weeec
 */
public class Tile_9 extends Tile{
    public Tile_9(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile9, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile9.getWidth(),Assets.tile9.getHeight());
    }
