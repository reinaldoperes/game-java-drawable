 ...
 * @author weeec
 */
public class Tile_4 extends Tile{
    public Tile_4(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile4, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile4.getWidth(),Assets.tile4.getHeight());
    }
