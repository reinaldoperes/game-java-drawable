 ...
 * @author weeec
 */
public class Tile_3 extends Tile{
    public Tile_3(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile3, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile3.getWidth(),Assets.tile3.getHeight());
    }
