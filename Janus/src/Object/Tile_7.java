 ...
 * @author weeec
 */
public class Tile_7 extends Tile{
    public Tile_7(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile7, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile7.getWidth(),Assets.tile7.getHeight());
    }
