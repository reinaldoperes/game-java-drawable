 ...
 * @author weeec
 */
public class Tile_11 extends Tile{
    public Tile_11(int x,int y){
        this.x = x;
        this.y = y;
    }
    ...
    public void draw(Graphics2D g){
          g.drawImage(Assets.tile11, x, y-3, null);
    }
    
     public Rectangle Limits(){
        return new Rectangle(x,y,Assets.tile11.getWidth(),Assets.tile11.getHeight());
    }
